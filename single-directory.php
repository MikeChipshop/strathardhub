<?php get_header(); ?>
    <?php if(get_field('directory_location_location')): ?>
        <style type="text/css">
            .acf-map {
                width: 100%;
                height: 400px;
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbcAWwfsnrtPJflT9Vya-vNCDtlpubuac&callback=Function.prototype"></script>
            ...
            <?php while (have_posts()) : the_post(); ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class('sbh_single-listing'); ?>>
                    <aside>
                        ...
                        <?php endif; ?>   
                        <?php if(get_field('directory_add_location')): ?>                     
                            <div class="sbh_single-listing-meta location">
                                <h2>Location</h2>
                                <ul>
                                    <?php if(get_field('directory_business_address')): ?>
                                        <li>
                                            <strong>Address:</strong><br />
                                            <?php the_field('directory_business_address'); ?>
                                        </li>
                                    <?php endif; ?>                                    
                                </ul>

                                <?php $location = get_field('directory_location_location'); ?>
                                <?php if( $location ): ?>
                                    <div class="sbh_single-listing-map">                                    
                                ...
                                <?php if(get_field('directory_location_what3words')): ?>
                                    <ul>
                                        <li>
                                            <strong>what3words: </strong> 
                                            <a href="https://what3words.com/<?php the_field('directory_location_what3words'); ?>" target="_blank" rel="noopener noreferrer">
                                                <?php the_field('directory_location_what3words'); ?>
                                            </a>                                    
                                        </li>
                                    </ul>
                                <?php endif; ?>
                        ...
                        <div class="sbh_single-listing-meta contact">
                            <h2>Contact</h2>
                            <ul>
                                <?php if(get_field('directory_business_email')): ?>
                                    <li>
                                        <strong>Email: </strong><a href="mailto:<?php the_field('directory_business_email'); ?>" target="_blank"><?php the_field('directory_business_email'); ?></a>
                                    </li>
                                <?php endif; ?>                                
                                <?php if(get_field('directory_business_phone')): ?>
                                    <li>
                                        <?php 
                                            $phone = get_field('directory_business_phone');
                                            $phone = str_replace(" ", "", $phone); 
                                            $country_code = '44';           
                                            $phone = substr_replace($phone, '+'.$country_code, 0, ($phone[0] == '0'));
                                        ?>
                                        <strong>Phone: </strong> <a href="tel:<?php echo $phone; ?>"><?php the_field('directory_business_phone'); ?></a>                                    
                                    </li>
                                <?php endif; ?>
                                <?php if(get_field('directory_business_website')): ?>
                                    <li>
                                        <a href="<?php the_field('directory_business_website'); ?>" target="_blank" rel="noopener noreferrer" class="visit-site">Visit Website</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                            ...
                            <div class="sbh_single-listing-social sbh_single-listing-meta">
                                ...
                                <ul>                                
                                    <?php while( have_rows('directory_business_social_media') ) : the_row(); ?>
                                        <li>
                                            <a href="<?php the_sub_field('directory_business_social_media_url'); ?>" title="<?php the_title(); ?> <?php the_sub_field('directory_business_social_media_type'); ?>" target="_blank" rel="noopener noreferrer">
